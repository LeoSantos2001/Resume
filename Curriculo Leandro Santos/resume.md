...
Platform Engineer com mais de 3 anos de experiência em ambientes críticos, atuando com Linux (RHEL), OpenShift e Kubernetes. Forte atuação em automação com Ansible, gestão de clusters, troubleshooting e resposta a incidentes em produção (N3), além de experiência em AWS e Azure.
